...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            parametros.Add(new System.Data.SqlClient.SqlParameter("CPF", cliente.CPF)); //adicionei
        ...
        {
            List<System.Data.SqlClient.SqlParameter> parametros = new List<System.Data.SqlClient.SqlParameter>();
            List<System.Data.SqlClient.SqlParameter> paramBeneficiarios = new List<System.Data.SqlClient.SqlParameter>();

            parametros.Add(new System.Data.SqlClient.SqlParameter("Id", Id));
            paramBeneficiarios.Add(new System.Data.SqlClient.SqlParameter("Id", Id));
            
            DataSet ds = base.Consultar("FI_SP_ConsCliente", parametros);
            DataSet dsBen = base.Consultar("FI_SP_ConsBeneficiario", paramBeneficiarios);

            List<Cliente> cli = Converter(ds);

            DaoBeneficiario daoBeneficiario = new DaoBeneficiario();
            List<Beneficiario> beneficiarios = daoBeneficiario.Converter(dsBen);
